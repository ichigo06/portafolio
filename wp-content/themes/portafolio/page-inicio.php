<?php get_header(); ?>
<section style="background-image: url('<?php echo get_template_directory_uri() ?>/img/fondo-cv.jpg'); background-size: cover; height: 100vh;" class="d-flex align-items-center">
    <div class="container">
